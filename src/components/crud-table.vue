  ...
  <div>
    <b-row>
      ...
      <b-col sm="3" class="my-2">
        <b-form-group label="Mode:" label-size="sm" label-cols-sm="3">
          <b-form-select v-model="selectMode" size="sm" :options="modes"></b-form-select>
        </b-form-group>
      </b-col>
      <!--End Selection Mode -->
      <b-col sm="1" class="my-2">
        <b-button size="sm" @click="selectAllRows" variant="primary">
             <vue-fontawesome icon="bell" size="1" color="lightgray"></vue-fontawesome>
        </b-button>&nbsp;
        <b-button size="sm" @click="clearSelected" variant="primary">
          <vue-fontawesome icon="trash" size="1" color="lightgray"></vue-fontawesome>
        </b-button>
      </b-col>
      <b-col sm="3" class="my-2">
 ...
 <b-col sm="3" class="my-2">
    ...
    >
      ...
      <template #cell(action)="data">
        ...
        <b-button @click="deleteItem(data.item)" v-b-modal="'edit-modal'" variant="danger" size="sm">
          <vue-fontawesome icon="trash" size="1" color="lightgray"></vue-fontawesome>
        </b-button>
        &nbsp;
        <b-button
